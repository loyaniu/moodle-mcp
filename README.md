...
2. Run `uv sync` to install the project and MCP CLI tools
3. Run `uv run mcp install src/moodle_mcp/server.py -f .env --with-editable .` to add the moodle-mcp server to Claude app
